...
public class Captcha extends LinearLayout {
    ...
    public Captcha(@NonNull final Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        thumbDrawableId = typedArray.getResourceId(R.styleable.Captcha_thumbDrawable, R.drawable.thumb_normal);
        ...
        isDialogStyle = typedArray.getBoolean(R.styleable.Captcha_isDialogStyle, false);
        typedArray.recycle();
        init();
    }
    ...
    private void init() {
        View parentView = LayoutInflater.from(getContext()).inflate(isDialogStyle ? R.layout.dialog_style_container : R.layout.container, this, true);
    ...
    //调用函数缩小图片
    public BitmapDrawable getNewDrawable(Captcha context, int restId, int dstWidth, int dstHeight) {
    ...
    public void setSeekBarStyle(@DrawableRes int progressDrawable, @DrawableRes int thumbDrawable) {
        ...
        Drawable drawable = getNewDrawable(this, thumbDrawable, 500, 500);
